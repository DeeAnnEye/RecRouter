    ...
    <nav class="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-gray-50 pt-5 pb-4">
      ...
      <div class="mt-5 flex-grow">
        <div class="space-y-1">
          ...
          <a href="{{ url('/profile', Auth::user()->id) }}" class="border-transparent text-gray-600 hover:text-gray-900 hover:bg-gray-50 group border-l-4 py-2 px-3 flex items-center text-sm font-medium">
